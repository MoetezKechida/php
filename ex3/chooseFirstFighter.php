...
if(!isset($_SESSION['choice1']))
{
    ...
    {
        $_SESSION['choice1']=new Pokemon("Rayquaza",
        "./images/Rayquaza.png"
        ,800,50,150,2,50);
    }
    else if($_GET['name']=='Deoxys')
    {
        $_SESSION['choice1']=new Pokemon("Deoxys",
        "./images/Deoxys.png",
        650,40,120,3,50);
    }
    ...
    {
        $_SESSION['choice1']=new PokemonFeu("Charizard",
    ...
    {
        $_SESSION['choice1']=new PokemonPlante("Venusaur",
        "./images/Venusaur.png",
        900,20,120,3,50);
    }
}
